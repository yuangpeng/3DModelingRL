...
def parse_args():
    ...
    parser.add_argument('--reference', type=str, default='depth',
                        help='type of shape reference, rgb or depth image')
    parser.add_argument('--category', type=str, default='airplane-02691156',
                        help='category name, should be consistent with the name used in file path')
    parser.add_argument('--data_root', type=str, default='../data/',
                        help='root directory of all the data')

    parser.add_argument('--load_net', type=str, default='../pretrained/Mesh/',
                        help='directory to load the pre-trained network parameters')
    parser.add_argument('--save_result', type=str, default='../data/mesh_result/',
                        help='directory to save the modeling results')
...
if __name__ == "__main__":
    ...
    test_shapelist_path = args.data_root + 'shape_list/' + \
        shape_category + '/' + shape_category + '-test.txt'
    ...
    mean_reward, mean_IOU_init, mean_IOU_edit = test(
        agent, env, test_shapelist)
