...
class Agent(object):
    ...
    def learn(self, learning_mode, is_ddqn=True):
        ...
        bstep = torch.FloatTensor(np.concatenate((bstep1, bstep2), axis=0))
        ...
        bbox_ = torch.FloatTensor(np.concatenate((bbox_1, bbox_2), axis=0))
        bstep_ = torch.FloatTensor(np.concatenate((bstep_1, bstep_2), axis=0))
